...
class Line extends Versions {
    ...
    public boolean checkDown(char board[][]) {
        if(verNo == 1 && (board[x[3] + 1][y[3]] == '#')) {
            return true;
        } else if(verNo == 2 && ( board[x[0] + 1][y[0]] == '#' 
        || board[x[1] + 1][y[1]] == '#' || 
        board[x[2] + 1][y[2]] == '#' 
        || board[x[3] + 1][y[3]] == '#')) {
            return true;
...
class T extends Versions {
    ...
    public boolean checkDown(char board[][]) {
        if(verNo == 1 && (board[x[0] + 1][y[0]] == '#' 
        || board[x[2] + 1][y[2]] == '#' || board[x[3] + 1][y[3]] == '#')) {
            return true;
        } else if(verNo == 2 && ( board[x[2] + 1][y[2]] == '#' 
        || board[x[3] + 1][y[3]] == '#')) {
            return true;
        } else if(verNo == 3 && (board[x[0] + 1][y[0]] == '#' 
        || board[x[1] + 1][y[1]] == '#' || board[x[2] + 1][y[2]] == '#')) {
            return true;
...
class L extends Versions {
    ...
    public boolean checkDown(char board[][]) {
        if(verNo == 1 && (board[x[2] + 1][y[2]] == '#' || board[x[3] + 1][y[3]] == '#')) {
            return true;
        } else if(verNo == 2 && ( board[x[0] + 1][y[0]] == '#' || board[x[1] + 1][y[1]] == '#' 
        || board[x[2] + 1][y[2]] == '#')) {
            return true;
...
class Z extends Versions{
    ...
    public boolean checkDown(char board[][]) {
        if((verNo == 1 || verNo == 3 ) && (board[x[1] + 1][y[1]] == '#' 
        || board[x[3] + 1][y[3]] == '#')) {
            return true;
        } else if((verNo == 2 || verNo == 4 ) && 
        ( board[x[0] + 1][y[0]] == '#' || board[x[2] + 1][y[2]] == '#'
        || board[x[3] + 1][y[3]] == '#')) {
            return true;
        }
        return false;
...
public class Tetris {
    ...
    public static void moveDown(Versions V) {
        if(V.x[0] == (board.length - 2) || V.x[1] == (board.length - 2) || 
        V.x[2] == (board.length - 2) || V.x[3] == (board.length - 2) || V.checkDown(board)) {
            for(int i:V.x ) {
                hashCount[i]++;
